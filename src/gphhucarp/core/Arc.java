...
public class Arc implements Comparable<Arc> {
    ...
    public Arc(double priority){
        this.priority = priority;
        this.demandSampler = new NormalSampler(5, 0.2 * 5);
        this.costSampler = new NormalSampler(5, 0.2 * 5);
    };
    ...
    public NodeSeqRoute getMinRoute() { return minRoute; }

    public void setMinRoute(NodeSeqRoute route) { this.minRoute = route; }
