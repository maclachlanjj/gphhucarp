...
public abstract class EvaluationModel {
    ...
    /**
     * These have been added as methods of madifying the *collaborative* algorithm:
     * Jordan MacLachlan 11/14/2019
     */
    public static final String P_REFILLTYPE = "refill-type";
    ...
    public void setup(final EvolutionState state, final Parameter base) {
        ...
        for (int i = 0; i < numInstances; i++) {
            ...
            /**
             * Determines whether to expend remaining capacity en route to depot (1) or simply return (0 - default).
             */
            p = b.push(P_REFILLTYPE);
            if(this instanceof CollaborativeEvaluationModel)
                CollaborativeDecisionProcess.refillType = state.parameters.getIntWithDefault(p, null, 0);
